...
mels_path = '/work/tc062/tc062/plarkin/FastPitches/PyTorch/SpeechSynthesis/FastPitch/reagan_all/mels/reagan_1948_002.pt'
...
plt.colorbar(format='%+2.0f dB')
plt.title('Mel spectrogram reagan 1948 002')
plt.tight_layout()
plt.savefig('reagan_all/plots/1948_002.png')
plt.show()