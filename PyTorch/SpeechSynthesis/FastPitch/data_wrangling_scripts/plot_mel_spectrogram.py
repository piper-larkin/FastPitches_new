...
mels_path = '/work/tc062/tc062/plarkin/FastPitches/PyTorch/SpeechSynthesis/FastPitch/TC_all/testset_TC_inf/mels/cooke_2002-11-08_041.pt'
...
plt.colorbar(format='%+2.0f dB')
plt.title('Mel spectrogram cooke_2002-11-08_041')
plt.tight_layout()
plt.savefig('figures/cooke_2002-11-08_041_mels_true.png')
plt.show()