...
: ${OUTPUT_DIR:="./TC_all/TC_LJ_smaller_out"}  # Changed
: ${DATASET_PATH:=TC_all}
: ${TRAIN_FILELIST:=TC_all/tc_LJ_spk_age_train_smaller.txt}  # Changed 
: ${VAL_FILELIST:=TC_all/tc_LJ_spk_age_dev_smaller.txt} # Changed
: ${AMP:=false}
: ${SEED:=""}
