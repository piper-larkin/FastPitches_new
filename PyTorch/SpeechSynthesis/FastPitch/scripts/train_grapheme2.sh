...
: ${OUTPUT_DIR:="./TC_all/less_cooke"}  # Changed
: ${DATASET_PATH:=TC_all}
: ${TRAIN_FILELIST:=TC_all/tc_less_cooke_train.txt}  # Changed 
: ${VAL_FILELIST:=TC_all/tc_less_cooke_dev.txt} # Changed
: ${AMP:=false}
: ${SEED:=""}
...
: ${NSPEAKERS:=17}  # changed from 1 and from 17
: ${SAMPLING_RATE:=22050}
